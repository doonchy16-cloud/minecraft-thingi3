...
public final class RegionState {
    ...
    public EvolutionPressures pressures() { if (pressures == null) pressures = EvolutionPressures.baseline(); return pressures; }
    public SpatialField spatial() { if (spatial == null) spatial = new SpatialField(); return spatial; }
    ...
    public void recordMaterializationResult(int changedBlocks, long tick) { if (changedBlocks > 0) markMaterialized(tick); }
